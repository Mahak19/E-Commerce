...
// Mac component for displaying MacBook products
const Mac = () => {
  // Redux state variables for product data and loading status
  const {
    isLoading,
    products,
    productCount,
  ...
  // State variable for current page of pagination
  ...
  // Effect hook to fetch products on component mount or page change
  useEffect(() => {
    dispatch(getProducts("", currentPage, [0, 1000000], "Laptop", 0));
  }, [dispatch, currentPage]);

  // Rendering the Mac component
  return (
    <>
      <Metadata title={"Mac"} />

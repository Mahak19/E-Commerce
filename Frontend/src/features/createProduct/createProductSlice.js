...
// Initializing initial state for the createProduct slice
const initialState = {};

// Creating a slice of the Redux store for managing product creation related actions and state
export const createProductSlice = createSlice({
  name: "createProduct", // Name of the slice
  initialState, // Initial state
  reducers: {
    // Reducer function for handling product creation request
    createProductRequest: (state) => {
      state.isLoading = true; // Setting isLoading flag to true to indicate request is in progress
    },
    // Reducer function for handling successful product creation
    ...
    // Reducer function for handling failed product creation
